...
//     const fields = ['Client', 'Management', 'Property'].map(v=>collectionName+v); // fields
...
//     const required = [...fields.filter(v => !['transactionManagement'].includes(v))]; // required fields
...
//     // init
//     const autoCompleteFields = ['Client', 'Management', 'Property'].map(v=>collectionName+v);
//     const autoIndex = -1;
